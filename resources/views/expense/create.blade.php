            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="panel panel-inverse">
                        ...
                        <form class="form-horizontal" action="{{ url('/expense/store') }}" method="POST" autocomplete="off" role="form-horizontal" id="expense-form" enctype="multipart/form-data">
                                ...
                                {{ csrf_field() }}
                                  <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('voucher_no') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" class="form-control" id="voucher_no" name="voucher_no" placeholder="Voucher No" value="{{ $voucher_no }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('voucher_date') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-12">
                                               <input type="text" class="datepicker-autoclose form-control" id="voucher_date" name="voucher_date"  data-date-format="dd-mm-yyyy" value="{{ date('d-m-Y') }}">
                                            ...
                                            <div class="col-md-12">
                                                 <select class="form-control select2" name="expense_account" id="expense_account">
                                                    ...
                                                    @foreach($accounts as $account)
                                                        <option @if(old('expense_account')==$account->account_id) selected @endif value="{{ $account->account_id }}">{{ $account->account_name }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="form-group{{ $errors->has('paid_through') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-12">
                                                 <select class="form-control select2" name="paid_through" id="paid_through">
                                                    ...
                                                    @foreach($accounts as $account)
                                                        <option @if(old('paid_through')==$account->account_id) selected @endif value="{{ $account->account_id }}">{{ $account->account_name }}</option>
                                                    @endforeach
                                                </select>
