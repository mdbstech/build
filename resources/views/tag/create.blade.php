                ...
                <div class="col-md-6">
                    <div class="panel panel-inverse">
                       <div class="panel-heading">New Tag</div>
                        <form class="form-horizontal" action="{{ url('/tag/store')}}" method="POST" autocomplete="off" role="form-horizontal"
                         id="tag-form">
                         <div class="panel-body">
                             ...
                             <div class="col-md-6">
                                <div class="form-group{{ $errors->has('tag_color') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                       <input type="text" class="form-control" id="tag_color" name="tag_color" placeholder="tag color" value="{{ old('tag_color') }}">
