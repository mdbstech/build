            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="panel panel-inverse">
                       <div class="panel-heading">New Assign User</div>
                        <form class="form-horizontal" action="{{ url('/assign_user/store')}}" method="POST" autocomplete="off" role="form-horizontal"
                         id="assign_user-form">
                                        ...
                                        <div class="col-md-12">
                                          <select id="user_id" name="user_id" class="form-control" autofocus>
                                              ...
                                              @foreach($users as $user)
                                                <option @if(old('user_id')==$user->user_id) selected @endif value="{{ $user->user_id }}">{{ $user->username }}</option>
                                              @endforeach
                                          </select>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="pull-right">
                                            ...
                                            <a href="{{ url('/assign_user/create/'.$contact->contact_id) }}" class="btn btn-danger waves-effect waves-light">Discard</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
