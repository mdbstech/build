            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="panel panel-inverse">
                        <div class="panel-heading">New Accounts</div>
                        <form class="form-horizontal" action="{{ url('/account/store') }}" method="POST" autocomplete="off" role="form-horizontal" id="account_type-form">
                                ...
                                {{ csrf_field() }}
                                            ...
                                            <div class="col-md-12">
                                                <select id="account_type_id" name="account_type_id" class="form-control" autofocus>
                                                    ...
                                                    @foreach($account_types as $account_type)
                                                        <option @if(old('account_type_id')==$account_type->account_type_id) selected @endif value="{{ $account_type->account_type_id }}">{{ $account_type->account_type }}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('account_code') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" class="form-control" id="account_code" name="account_code" placeholder="Account Code" value="{{ $account_code }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('account_no') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" class="form-control" id="account_no" name="account_no" placeholder="Account No" value="{{ old('account_no') }}">
                                    ...
                                    <div class="col-md-6">
                                         <div class="form-group{{ $errors->has('ifsc_code') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" class="form-control" id="ifsc_code" name="ifsc_code" placeholder="IFSC Code" value="{{ old('ifsc_code') }}">
                                        ...
                                        <div class="form-group{{ $errors->has('account_status') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-12">
                                                 <select class="form-control" id="account_status" name="account_status">
                                                    <option value="0" @if(old('account_status')=='0') selected @endif>Active</option>
                                                    <option value="1" @if(old('account_status')=='1') selected @endif>In Active</option>
                                                </select>
                                    ...
                                    <div class="col-md-12">
                                         <div class="form-group{{ $errors->has('account_description') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-12">
                                                <textarea type="text" class="form-control" id=" account_description" name="account_description" placeholder="Account Description">{{ old('account_description') }}</textarea>
