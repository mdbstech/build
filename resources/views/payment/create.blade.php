            ...
            <div class="row m-t-15">
                <div class="col-md-6">
                     <div class="panel panel-color panel-custom">
                        ...
                        <form class="form-horizontal" action="{{ url('/payment/store')}}" method="POST" autocomplete="off" role="form-horizontal"
                         id="payment-form">
                         <div class="panel-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group form_datetime{{ $errors->has('receipt_date') ? ' has-error' : '' }}">
                                    <div class="col-md-6">
                                        <label for="receipt_date" class="control-label">ReceiptDate*</label>
                                    </div>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" id="receipt_date" name="receipt_date"  data-date-format="d-m-yyyy"  value="{{ date('d-m-Y') }}" >
                            ...
                            <div class="col-md-6">
                                <div class="form-group form_datetime{{ $errors->has('date') ? ' has-error' : '' }}">
                                    <div class="col-md-6">
                                        <label for="date" class="control-label"> Date</label>
                                    </div>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" id="date" name="date"  data-date-format="d-m-yyyy"  value="{{ date('d-m-Y') }}" >
                            ...
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('num') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                       <input type="text" class="form-control" id="num" name="num" placeholder="Number " value="{{ old('num') }}">
                                        @if ($errors->has('num'))
                                            <span class="help-block">
