            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="panel panel-inverse">
                       <div class="panel-heading">New Payment Term</div>
                        <form class="form-horizontal" action="{{ url('/payment_term/store')}}" method="POST" autocomplete="off" role="form-horizontal"
                         id="payment_term-form">
                         <div class="panel-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('payment_term') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" class="form-control" id="payment_term" name="payment_term" placeholder="payment term" value="{{ old('payment_term') }}">
                             ...
                             <div class="col-md-6">
                                <div class="form-group{{ $errors->has('no_of_days') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                       <input type="text" class="form-control" id="no_of_days" name="no_of_days" placeholder="no of days " value="{{ old('no_of_days') }}">
