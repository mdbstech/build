            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <a href="{{ url('/contact/create') }}">New FollowUp</a>
                        </li>
                        <li class="active">
                            <a href="{{ url('/contact/display') }}">FollowUps</a>
                        </li>
                ...
                <div class="col-md-6">
                    <div class="panel panel-inverse">
                       <div class="panel-heading">New FollowUp</div>
                        <form class="form-horizontal" action="{{ url('/calllog/update/'.$calllog->calllog_id) }}"" method="POST" autocomplete="off" role="form-horizontal" id="callog-form" enctype="multipart/form-data">
                        <div class="panel-body">
                                    ...
                                    <div class="col-md-12">
                                        <select id="contact_id" name="contact_id" class="form-control" autofocus>
                                            ...
                                            @foreach($contacts as $contact)
                                                <option @if($calllog->contact_id==$contact->contact_id) selected @endif value="{{ $contact->contact_id }}">{{ $contact->contact_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-12">
                                        <select id="user_id" name="user_id" class="form-control" autofocus>
                                            ...
                                            @foreach($agents as $agent)
                                                <option @if($calllog->user_id==$agent->user_id) selected @endif value="{{ $agent->user_id }}">{{ $agent->username }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group form_datetime{{ $errors->has('call_log') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" id="call_log" name="call_log"  data-date-format="d-m-yyyy H:i:s"  value="{{ date('d-m-Y H:i:s',strtotime($calllog->call_log)) }}" readonly="">
                            ...
                            <div class="col-md-6">
                                <div class="form-group form_datetime{{ $errors->has('followup_date') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" id="followup_date" name="followup_date"  data-date-format="d-m-yyyy H:i:s" value="{{ date('d-m-Y H:i:s',strtotime($calllog->followup_date)) }}" readonly="">
                            ...
                            <div class="col-md-12">
                                <div class="form-group{{ $errors->has('note') ? ' has-error' : '' }}">
                                    <div class="col-md-12">
                                      ...
                                      <div class="col-md-12">
                                        <textarea type="text" class="form-control" id="note" name="note" placeholder="Note" value="{{ old('note') }}">{{ $calllog->note }}</textarea>
                                        @if ($errors->has('note'))
                                            <span class="help-block">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($calllogs as $calllog)
                                            <tr>
                                                ...
                                                <td>{{ $calllog->Contact->contact_name }}</td>
