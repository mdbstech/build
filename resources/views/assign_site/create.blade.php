        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h4 class="page-title">Assign Site</h4>
                    <ol class="breadcrumb">
                        <li>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="panel panel-inverse">
                       <div class="panel-heading">New Assign Site</div>
                        <form class="form-horizontal" action="{{ url('/assign_site/store')}}" method="POST" autocomplete="off" role="form-horizontal"
                         id="assign_site-form">
                         <div class="panel-body">
                                     ...
                                     <div class="col-md-12">
                                       <select id="site_id" name="site_id" class="form-control" autofocus>
                                           ...
                                           @foreach($sites as $site)
                                             <option @if(old('site_id')==$site->site_id) selected @endif value="{{ $site->site_id }}">{{ $site->site_no }}</option>
                                           @endforeach
                                       </select>
                            ...
                            <div class="col-md-6">
                               <div class="form-group{{ $errors->has('assign_date') ? ' has-error' : '' }}">
                                   ...
                                   <div class="col-md-12">
                                      <input type="text" class="datepicker-autoclose form-control" id="assign_date" name="assign_date" data-date-format="dd-mm-yyyy" value="{{ date('d-m-Y') }}">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="pull-right">
                                            ...
                                            <a href="{{ url('/assign_site/create') }}" class="btn btn-danger waves-effect waves-light">Discard</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
