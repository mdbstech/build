            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="panel panel-inverse">
                       <div class="panel-heading">New Follow Up</div>
                        <form class="form-horizontal" action="{{ url('/follow_up/store')}}" method="POST" autocomplete="off" role="form-horizontal"
                         id="follow_up-form">
                         <div class="panel-body">
                                       ...
                                       <div class="col-md-12">
                                         <select id="contact_id" name="contact_id" class="form-control" autofocus>
                                             ...
                                             @foreach($contacts as $con)
                                               <option  @if($contact->contact_id==$con->contact_id) selected @endif value="{{ $con->contact_id }}">{{ $con->contact_name }}</option>
                                             @endforeach
                                         </select>
                              ...
                              <div class="col-md-6">
                                 <div class="form-group{{ $errors->has('date') ? ' has-error' : '' }}">
                                     ...
                                     <div class="col-md-12">
                                        <input type="text" class="datepicker-autoclose form-control" id="date" name="date" data-date-format="dd-mm-yyyy" value="{{ date('d-m-Y') }}">
                                         @if ($errors->has('date'))
                                             <span class="help-block">
                              ...
                              <div class="col-md-6">
                                 <div class="form-group{{ $errors->has('time') ? ' has-error' : '' }}">
                                     ...
                                     <div class="col-md-12">
                                         <input type="text" class="form-control" id="time" name="time" placeholder="time" value="{{ old('time') }}">
                                         @if ($errors->has('time'))
                                             <span class="help-block">
                              ...
                              <div class="col-md-12">
                                 <div class="form-group{{ $errors->has('follow_up_description') ? ' has-error' : '' }}">
                                     ...
                                     <div class="col-md-12">
                                         <textarea type="text" class="form-control" id="follow_up_description" name="follow_up_description" placeholder="follow up description">{{ old('follow_up_description') }}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="pull-right">
                                            ...
                                            <a href="{{ url('/follow_up/create/'.$contact->contact_id) }}" class="btn btn-danger waves-effect waves-light">Discard</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-nowrap">
                                                    <a href="{{ url('/follow_up/edit/'.$follow_up->follow_id) }}" data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-pencil text-inverse m-r-10"></i></a>
                                                      ...
                                                      <a href="{{ url('/follow_up/view/'.$follow_up->follow_id) }}" data-toggle="tooltip" data-original-title="View"> <i class="fa fa-eye text-inverse m-r-10"></i></a>
