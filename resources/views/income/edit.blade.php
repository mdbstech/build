            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="panel panel-inverse">
                        ...
                        <form class="form-horizontal" action="{{ url('/income/update/'.$income->income_id) }}" method="POST" autocomplete="off" role="form-horizontal" id="income-form" enctype="multipart/form-data">
                                ...
                                {{ csrf_field() }}
                                  <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('receipt_no') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" class="form-control" id="receipt_no" name="receipt_no" placeholder="Voucher No" value="{{ $income->receipt_no }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('receipt_date') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-12">
                                               <input type="text" class="datepicker-autoclose form-control" id="receipt_date" name="receipt_date"  data-date-format="dd-mm-yyyy" value="{{ date('d-m-Y',strtotime($income->receipt_date)) }}">
                                            ...
                                            <div class="col-md-12">
                                                 <select class="form-control select2" name="income_account" id="income_account">
                                                    ...
                                                    @foreach($accounts as $account)
                                                        <option @if($income->income_account==$account->account_id) selected @endif value="{{ $account->account_id }}">{{ $account->account_name }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="form-group{{ $errors->has('deposit_to') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-12">
                                                 <select class="form-control select2" name="deposit_to" id="deposit_to">
                                                    ...
                                                    @foreach($accounts as $account)
                                                        <option @if($income->deposit_to==$account->account_id) selected @endif value="{{ $account->account_id }}">{{ $account->account_name }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-12">
                                                <select id="contact_id" name="contact_id" class="form-control" autofocus>
                                                    ...
                                                    @foreach($contacts as $contact)
                                                        <option @if($income->contact_id==$contact->contact_id) selected @endif value="{{ $contact->contact_id }}">{{ $contact->contact_name }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-12">
                                                <select id="payment_mode" type="text" class="form-control" name="payment_mode">
                                                    ...
                                                    @foreach($payment_modes as $payment_mode)
                                                        <option @if($income->payment_mode==$payment_mode->master_value) selected @endif>{{ $payment_mode->master_value }}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" class="form-control" id="amount" name="amount" placeholder="Amount" value="{{ $income->amount }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('note') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-12">
                                                <textarea rows="5" type="text" class="form-control" id="note" name="note" placeholder="Note">{{ $income->note }}</textarea>
                                                @if ($errors->has(' note'))
                                                    <span class="help-block">
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr
                                            ...
                                            <th class="text-nowrap" >DepositTo</th>
