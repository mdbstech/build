            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="panel panel-inverse">
                       <div class="panel-heading">New AccountType</div>
                        <form class="form-horizontal" action="{{ url('/account_type/store') }}" method="POST" autocomplete="off" role="form-horizontal"
                         id="account_type-form">
                         <div class="panel-body">
                             ...
                             <div class="col-md-12">
                                <div class="form-group{{ $errors->has('account_type') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" id="account_type" name="account_type" placeholder="Account Type" value="{{ old('account_type') }}">
                            ...
                            <div class="col-md-12">
                                <div class="form-group{{ $errors->has('account_type_description') ? ' has-error' : '' }}">
                                    <div class="col-md-12">
                                        <label for="account_type_description" class="control-label">Account Type Description </label>
                                    </div>
                                    <div class="col-md-12">
                                        <textarea type="text" class="form-control" id="account_type_description" name="account_type_description" placeholder="Description" value="{{ old('account_type_description') }}"></textarea>
