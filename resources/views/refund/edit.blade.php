                ...
                <div class="col-md-6">
                    <div class="panel panel-color panel-custom">
                        <div class="panel-heading">
                            <h3 class="panel-title">EDIT REFUND</h3>
                        </div>
                        <form class="form-horizontal" action="{{ url('/refund/update/'.$refund->refund_id )}}" method="POST" autocomplete="off" role="form-horizontal"
                         id="refund-form">
                         <div class="panel-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('voucher_no') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" id="voucher_no"  name="voucher_no" placeholder="Voucher No" value="{{ $refund->voucher_no }}">
                             ...
                             <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('voucher_date') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input class="form-control" data-date-format="dd-mm-yyyy" data-link-format="dd-mm-yyyy" id="voucher_date" name="voucher_date" size="16" type="text" value="{{ date('d-m-Y', strtotime($refund->voucher_date )) }}" >
                                    ...
                                    <div class="col-md-12">
                                        <select id="contact_id" name="contact_id" class="form-control" autofocus>
                                            ...
                                            @foreach($contacts as $contact)
                                                <option  @if($refund->contact_id==$contact->contact_id) selected @endif value="{{ $contact->contact_id }}">{{ $contact->contact_name }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('payment_mode') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <select id="payment_mode" type="text" class="select2" name="payment_mode">
                                            ...
                                            @foreach($payment_modes as $payment_mode)
                                                <option @if($refund->payment_mode==$payment_mode->master_value) selected @endif>{{ $payment_mode->master_value }}</option>
                                            @endforeach
                                        </select>
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('date') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input class="form-control" data-date-format="dd-mm-yyyy" data-link-format="dd-mm-yyyy" id="date" name="date" size="16" type="text" value="{{ date('d-m-Y', strtotime($refund->date )) }}" >
                                            @if ($errors->has('date'))
                                                <span class="help-block">
                                ...
                                <div class="form-group{{ $errors->has('num') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                       <input type="text" class="form-control" id="num" name="num" placeholder="num " value="{{ $refund->num }}">
                                        @if ($errors->has('num'))
                                            <span class="help-block">
                            ...
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                       <input type="text" class="form-control" id="amount" name="amount" placeholder="amount " value="{{ $refund->amount }}">
        ...
        function Delete(refund_id)
        {
            if(confirm('Do you want to Continue...?'))
            {
                $.ajax({
                    ...
                    {
                        window.location='{{ url("/refund/create/".$contact->contact_id) }}';
                    },
                    error : function(date)
                    {
                        window.location='{{ url("/refund/create/".$contact->contact_id) }}';
